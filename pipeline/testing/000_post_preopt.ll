...
"4006c0":                                         ; preds = %"4006c0", %"4006b6"
  ...
  %76 = load i64, i64* %31, align 8, !tbaa !2, !alias.scope !450, !noalias !457
  %77 = add i64 %76, 1
  store i64 %77, i64* %31, align 8, !tbaa !2, !alias.scope !459, !noalias !466
  %78 = load i64, i64* %27, align 8, !tbaa !2, !alias.scope !468, !noalias !475
  %79 = icmp eq i64 %77, %78
  store i64 4196054, i64* %1, align 4
  br i1 %79, label %"4006d6", label %"4006c0"
...
; uselistorder directives
  uselistorder i64* %3, { 1, 0 }
  uselistorder i64* %1, { 1, 0 }
  uselistorder void (%struct.x86_config*, %struct.x86_regs*, i64)* @x86_jump_intrin, { 4, 1, 2, 3, 0 }
  uselistorder i64 8, { 2, 3, 0, 1, 4 }
  uselistorder %struct.x86_config* @config, { 4, 1, 2, 3, 0, 5 }
  uselistorder i32 0, { 0, 53, 1, 50, 2, 51, 3, 52, 4, 5, 6, 7, 8, 9, 10, 56, 11, 57, 12, 49, 13, 14, 15, 16, 17, 18, 19, 20, 21, 58, 22, 23, 24, 55, 25, 26, 59, 27, 28, 54, 30, 31, 32, 33, 34, 35, 29, 36, 37, 38, 60, 39, 40, 41, 42, 61, 43, 62, 45, 46, 44, 47, 48, 63 }
  uselistorder i32 9, { 4, 1, 2, 3, 7, 8, 0, 9, 6, 10, 5, 11, 12, 13, 14 }
  uselistorder i64 0, { 0, 61, 1, 58, 2, 59, 3, 60, 4, 65, 5, 6, 7, 8, 9, 10, 11, 66, 12, 67, 13, 57, 14, 15, 16, 17, 18, 19, 20, 22, 21, 23, 68, 24, 25, 26, 64, 27, 28, 69, 62, 29, 30, 63, 31, 33, 70, 34, 35, 36, 37, 38, 39, 32, 40, 41, 42, 71, 43, 44, 45, 46, 47, 48, 72, 49, 73, 51, 52, 53, 54, 74, 50, 75, 55, 56, 76 }
  uselistorder %struct.x86_regs* %0, { 1, 0, 2 }
}
