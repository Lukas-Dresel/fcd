...
entry:
  ...
  ret void
                                                  ; No predecessors!
  call void @fcd.placeholder.48(i64 %rip)
  ret void
...
entry:
  ...
  ret void
                                                  ; No predecessors!
  call void @fcd.placeholder.49(i64 %rip)
  ret void
...
entry:
  ...
  ret void
                                                  ; No predecessors!
  call void @fcd.placeholder.50(i64 %rip)
  ret void
...
"4006c0":                                         ; preds = %"4006c0", %entry
  %registers.sroa.0.0 = phi i64 [ 0, %entry ], [ %15, %"4006c0" ]
  ...
  br i1 %16, label %"4006d6", label %"4006c0"
                                                  ; No predecessors!
  call void @fcd.placeholder.51(i64 %rip, i64 %rdi, i64 %rsi, i64 %rdx)
  ret void
...
"4004b0":                                         ; preds = %entry
  ...
  br label %"4004b5"
                                                  ; No predecessors!
  call void @fcd.placeholder.52(i64 %rip)
  ret void
...
"4005d9":                                         ; preds = %entry
  ...
  br label %"4005ea"
                                                  ; No predecessors!
  call void @fcd.placeholder.53(i64 %rip)
  ret void
...
entry:
  ...
  ret void
                                                  ; No predecessors!
  call void @fcd.placeholder.54(i64 %rip)
  ret void
...
entry:
  ...
  ret void
                                                  ; No predecessors!
  call void @fcd.placeholder.55(i64 %rip)
  ret void
...
entry:
  ...
  unreachable
                                                  ; No predecessors!
  %7 = call %main.returns @fcd.placeholder.56(i64 %rip)
  ret %main.returns %7
...
entry:
  ...
  unreachable
                                                  ; No predecessors!
  call void @fcd.placeholder.57(i64 %rip)
  ret void

; uselistorder directives
  uselistorder i64 0, { 0, 1, 2, 3, 4, 5, 6, 7, 10, 11, 8, 9, 14, 15, 28, 12, 13, 26, 27, 18, 19, 16, 17, 20, 21, 22, 23, 24, 25 }
  uselistorder i64 %rip, { 1, 0 }
}
