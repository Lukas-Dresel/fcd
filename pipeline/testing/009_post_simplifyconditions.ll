...
entry:
  %0 = trunc i64 4294967295 to i32
  %1 = trunc i64 %rdi to i32
  %2 = add i64 %rsp, -8
  %3 = inttoptr i64 %2 to i64*
  store i64 %rip, i64* %3, align 4, !fcd.prgmem !3
  %4 = add i64 %rsp, -64
  call void @_init(i64 4196017, i64 %4)
  br i1 false, label %"4006d6", label %"4006b6"
...
"4006c0":                                         ; preds = %"4006c0", %"4006b6"
  %registers.sroa.0.0 = phi i64 [ 0, %"4006b6" ], [ %13, %"4006c0" ]
  %5 = phi i64 [ 0, %"4006b6" ], [ %13, %"4006c0" ]
  %6 = and i32 %1, %0
  %7 = zext i32 %6 to i64
  %8 = and i64 %rdi, 4294967295
  %9 = shl i64 %5, 3
  %10 = add i64 %9, 6295056
  %11 = inttoptr i64 %10 to void (i64, i64, i64)**
  %12 = load void (i64, i64, i64)*, void (i64, i64, i64)** %11, align 8
  call void %12(i64 %7, i64 %rsi, i64 %rdx)
  %13 = add i64 %registers.sroa.0.0, 1
  %14 = icmp eq i64 %registers.sroa.0.0, 0
  br i1 %14, label %"4006d6", label %"4006c0"
                                                  ; No predecessors!
  ret void
}
...
entry:
  ...
  %9 = call i64 @__libc_start_main(i64 4195862, i64 %rip, i64 %rsp, i64 4195968, i64 4196080, i64 %rdx, i64 %8)
...
"400646":                                         ; preds = %"400646", %entry
  %.in = phi i64 [ %9, %"400646" ], [ %2, %entry ]
  %6 = inttoptr i64 %.in to i8*
  %7 = load i8, i8* %6, align 1, !fcd.prgmem !3
  %8 = xor i8 %7, 66
  store i8 %8, i8* %6, align 1, !fcd.prgmem !3
  %9 = add i64 %.in, 1
  %10 = icmp eq i64 %9, %5
  br i1 %10, label %"400652", label %"400646"

"400652":                                         ; preds = %"400646"
  %11 = add i64 %rsp, -29
  %12 = inttoptr i64 %11 to i8*
  store i8 0, i8* %12, align 1, !fcd.prgmem !3
  %13 = call i64 @puts(i64 %2)
  store i64 undef, i64* null, align 536870912
  br i1 true, label %"400679", label %"400674"

"400679":                                         ; preds = %"400652", %"400674"
  %set.rdx = insertvalue %main.returns zeroinitializer, i64 %5, 1
